  ...
  <div class="flex flex-col gap-4">
    <Card :title="t('audio.title')">
      <div class="flex flex-col gap-4">
        <div class="flex gap-3">
          <Field v-if="settings.role === 'source'" :label="t('audio.inputDevice')" class="flex-1">
            <Select
        ...
        <div class="flex gap-3">
          <Field :label="t('audio.bufferSize')" class="flex-1">
          ...
          <Field v-if="settings.isServer" :label="t('audio.format')" class="flex-1">
    ...
    <Card>
      <div class="flex flex-col gap-4">
        ...
        <Field :label="t('audio.latencyProfile')">
        ...
        <template v-if="settings.latencyProfile === 'custom'">
          <div class="flex gap-3">
            <Field :label="t('audio.ringBufferDuration')" class="flex-1">
            ...
            <Field :label="t('audio.chunkSize')" class="flex-1">
          ...
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-[var(--color-text)]">{{ t("audio.adaptiveBuffer") }}</p>
              <p class="text-xs text-[var(--color-text-faint)]">
                {{ t("audio.adaptiveBufferDesc") }}
              </p>
            </div>
          ...
          <div class="flex gap-3">
            <Field :label="t('audio.minBuffer')" class="flex-1">
              <Input
            ...
            <Field :label="t('audio.maxBuffer')" class="flex-1">
              <Input
